...
const offsetX = wall.getBoundingClientRect().left + wallBorderWidth + spider.width / 2;
const maxX = wall.clientWidth - spider.clientWidth;
const offsetY = wall.getBoundingClientRect().top + wallBorderWidth + spider.height / 2;
...
function getCoordinate(eventCoordinate, offset, maxCoordinate) {
    ...
    if (coordinate > maxCoordinate) return maxCoordinate;
    return coordinate;
}
